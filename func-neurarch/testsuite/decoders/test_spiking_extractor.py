...
def run_test(stim_interval=None):
    ...
    ####################################################################################################################
    ########################################   Some plotting if wished   ###############################################
    ####################################################################################################################

    # neuron_id_to_plot = 8
    # snn.state_extractor.plot_samples('samp100_E', n_samples=5, neuron_id=neuron_id_to_plot)
    # snn.state_extractor.plot_samples('samp100_E', n_samples=5, neuron_id=neuron_id_to_plot)
    # snn.state_extractor.plot_samples('samp1000_E', n_samples=50, neuron_id=neuron_id_to_plot)
    #
    # assert np.isclose(snn.state_extractor.pop_extractors['samp100_E'].activity[0][5][1],
    #                   snn.state_extractor.pop_extractors['samp1000_E'].activity[0][5][10])
