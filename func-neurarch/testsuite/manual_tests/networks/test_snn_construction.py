...
from tools.visualization.plotting import plot_network_topology
...
# NOTE when running different systems in the same simulation, the population names (passed to create a NEST model)
# cannot repeat!
