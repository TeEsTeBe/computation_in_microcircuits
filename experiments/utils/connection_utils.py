...
def create_synapse_parameters(synapse_model='tsodyks2_synapse'):
    ...
    if synapse_model == 'static_synapse':
        syn_params_from_to = {
            'exc': {
                'exc': {compatability.syn_model_naming: synapse_model, 'delay': 1.5},
                'inh': {compatability.syn_model_naming: synapse_model, 'delay': 0.8},
            },
            'inh': {
                'exc': {compatability.syn_model_naming: synapse_model, 'delay': 0.8},
                'inh': {compatability.syn_model_naming: synapse_model, 'delay': 0.8},
            },
        }
    else:
        syn_params_from_to = {
            'exc': {
                'exc': {compatability.syn_model_naming: synapse_model, 'U': 0.5, 'tau_rec': 1.1e3, 'tau_fac': 0.05e3, 'delay': 1.5},
                'inh': {compatability.syn_model_naming: synapse_model, 'U': 0.05, 'tau_rec': 0.125e3, 'tau_fac': 1.200e3, 'delay': 0.8},
            },
            'inh': {
                'exc': {compatability.syn_model_naming: synapse_model, 'U': 0.25, 'tau_rec': 0.7e3, 'tau_fac': 0.02e3, 'delay': 0.8},
                'inh': {compatability.syn_model_naming: synapse_model, 'U': 0.32, 'tau_rec': 0.144e3, 'tau_fac': 0.06e3, 'delay': 0.8},
            },
        }
